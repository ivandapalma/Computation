% kNN Euclidea
function salida = kNN_Euclidea(input_Norm,output,objeto,k)
    ...
    for i=1:Q
        objetoMejores_Norm(i) = (objeto(i) - medias(i)) / desviaciones(i);
    end
    ...
    dif = zeros(1,C);
    for i=1:C
        dif(i) = sqrt( (objetoMejores(1) - inputMejores(1,i))^2 + (objetoMejores(2) - inputMejores(2,i))^2 + (objetoMejores(3) - inputMejores(3,i))^2 );
    end
